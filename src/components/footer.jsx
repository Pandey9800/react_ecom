                  ...
                  {/* <div className="footer-bottom">
                      <div className="container">
                          <div className="section-wrapper">
                              <p className="text-dark">&copy; 2024 <Link to="/">Shop Cart</Link> Designed by <a href="/" target="_blank">RSP</a></p>
